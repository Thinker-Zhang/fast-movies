...
// GET 用来拉取随机一部热门电影
router.get('/movie/:id', controllers.movie.hot)

// GET 用来拉取热门电影列表
router.get('/movie', controllers.movie.list)

// POST 用来拉取热门电影详情
router.post('/movie', controllers.movie.detail)
...
// POST 用来拉取电影评论详情
router.post('/comment', controllers.comment.detail)

// GET 用来获取我的电影评论列表
router.get('/release', validationMiddleware, controllers.release.list)
